...
#define LED_TYPE             WS2811//type of LED strip to use(APA102 - DotStar, WS2811 - NeoPixel)
#define BUTTON               8
...
//    
//    joystickTilt = map(xValue, 0, 1023, 90, -90);
...
//    Serial.println(buttonState);
      ...
      radio.read(&message, sizeof(RFMessage));
//      Serial.println(message.buttonS);
      buttonState = message.buttonState;
      joystickTilt = message.joystickTilt;
      Serial.println(message.joystickTilt);
}
